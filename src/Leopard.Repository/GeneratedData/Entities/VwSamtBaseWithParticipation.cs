...
namespace Leopard.Repository
{
    ...
    public partial class VwSamtBaseWithParticipation
    {
        ...
        public string MosharekatName { get; set; } // MosharekatName (length: 1000)
        public double PercentMosharekat { get; set; } // PercentMosharekat
        public double? PayedMosharekat { get; set; } // PayedMosharekat

        public VwSamtBaseWithParticipation()
        {
            InitializePartial();
        }
