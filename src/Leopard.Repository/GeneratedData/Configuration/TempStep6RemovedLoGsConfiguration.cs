...
{
    // temp_step6RemovedLOGs
    public partial class TempStep6RemovedLoGsConfiguration : IEntityTypeConfiguration<TempStep6RemovedLoGs>
    {
        public void Configure(EntityTypeBuilder<TempStep6RemovedLoGs> builder)
        {
            builder.ToTable("temp_step6RemovedLOGs", "dbo");
        ...
        partial void InitializePartial(EntityTypeBuilder<TempStep6RemovedLoGs> builder);
    }
