...
namespace Leopard.Repository
{
    ...
    public partial class TempStep8RemovedLoGsConfiguration : IEntityTypeConfiguration<TempStep8RemovedLoGs>
    {
        public void Configure(EntityTypeBuilder<TempStep8RemovedLoGs> builder)
        {
            builder.ToTable("temp_step8RemovedLOGs", "dbo");
        ...
        partial void InitializePartial(EntityTypeBuilder<TempStep8RemovedLoGs> builder);
    }
