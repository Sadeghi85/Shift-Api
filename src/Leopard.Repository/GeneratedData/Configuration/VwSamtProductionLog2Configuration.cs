...
{
    // VW_SAMT_ProductionLog2
    public partial class VwSamtProductionLog2Configuration : IEntityTypeConfiguration<VwSamtProductionLog2>
    {
        public void Configure(EntityTypeBuilder<VwSamtProductionLog2> builder)
        {
            builder.ToView("VW_SAMT_ProductionLog2", "dbo");
            builder.HasNoKey();
        ...
        partial void InitializePartial(EntityTypeBuilder<VwSamtProductionLog2> builder);
    }
