...
namespace Leopard.Repository
{
    ...
    public partial class ShiftShiftTabletCrewConfiguration : IEntityTypeConfiguration<ShiftShiftTabletCrew>
    {
        public void Configure(EntityTypeBuilder<ShiftShiftTabletCrew> builder)
        {
            ...
            builder.Property(x => x.ShifTabletId).HasColumnName(@"ShifTabletId").HasColumnType("int").IsRequired();
            ...
            // Foreign keys
            builder.HasOne(a => a.SamtAgent).WithMany(b => b.ShiftShiftTabletCrews).HasForeignKey(c => c.AgentId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Shift_ShiftTableCrew_SAMT_Agents");
            ...
            builder.HasOne(a => a.ShiftShiftTablet).WithMany(b => b.ShiftShiftTabletCrews).HasForeignKey(c => c.ShifTabletId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Shift_ShiftTableCrew_Shift_ShiftTablet");
