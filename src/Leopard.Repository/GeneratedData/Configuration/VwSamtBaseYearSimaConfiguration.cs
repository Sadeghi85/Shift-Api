...
namespace Leopard.Repository
{
    ...
    public partial class VwSamtBaseYearSimaConfiguration : IEntityTypeConfiguration<VwSamtBaseYearSima>
    {
        public void Configure(EntityTypeBuilder<VwSamtBaseYearSima> builder)
        {
            builder.ToView("VW_SAMT_BaseYear_SIMA", "dbo");
            builder.HasNoKey();
        ...
        partial void InitializePartial(EntityTypeBuilder<VwSamtBaseYearSima> builder);
    }
