...
namespace Leopard.Repository
{
    ...
    public partial class BroadcastProgramTypeConfiguration : IEntityTypeConfiguration<BroadcastProgramType>
    {
        public void Configure(EntityTypeBuilder<BroadcastProgramType> builder)
        {
            builder.ToTable("BroadcastProgramTypes", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_BroadcastProgramTypes").IsClustered();
        ...
        partial void InitializePartial(EntityTypeBuilder<BroadcastProgramType> builder);
    }
