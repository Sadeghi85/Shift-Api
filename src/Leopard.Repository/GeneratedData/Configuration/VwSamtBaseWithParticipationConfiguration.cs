...
{
    // VW_SAMT_Base_With_Participation
    public partial class VwSamtBaseWithParticipationConfiguration : IEntityTypeConfiguration<VwSamtBaseWithParticipation>
    {
        public void Configure(EntityTypeBuilder<VwSamtBaseWithParticipation> builder)
        {
            builder.ToView("VW_SAMT_Base_With_Participation", "dbo");
            builder.HasNoKey();
            ...
            builder.Property(x => x.MosharekatName).HasColumnName(@"MosharekatName").HasColumnType("nvarchar(1000)").IsRequired(false).HasMaxLength(1000);
            builder.Property(x => x.PercentMosharekat).HasColumnName(@"PercentMosharekat").HasColumnType("float").HasPrecision(53).IsRequired();
            builder.Property(x => x.PayedMosharekat).HasColumnName(@"PayedMosharekat").HasColumnType("float").HasPrecision(53).IsRequired(false);

            InitializePartial(builder);
        }

        partial void InitializePartial(EntityTypeBuilder<VwSamtBaseWithParticipation> builder);
    }
