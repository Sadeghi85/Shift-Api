...
{
    // temp_step7Removed
    public partial class TempStep7RemovedConfiguration : IEntityTypeConfiguration<TempStep7Removed>
    {
        public void Configure(EntityTypeBuilder<TempStep7Removed> builder)
        {
            builder.ToTable("temp_step7Removed", "dbo");
        ...
        partial void InitializePartial(EntityTypeBuilder<TempStep7Removed> builder);
    }
